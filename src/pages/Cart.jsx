          ...
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="divide-y divide-gray-50">
              {cartItems.map((item, idx) => (
                <div key={item.id || item._id || idx} className="p-6 grid grid-cols-1 md:grid-cols-6 gap-6 items-center hover:bg-gray-50/30 transition">
                  {/* Product Info */}
                  <div className="col-span-1 md:col-span-3 flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 leading-tight mb-1 hover:text-primary transition">
                         <Link to={`/product/${item.id || item._id}`}>{item.title}</Link>
                      </h3>
