...
import { Search, User, Heart, ShoppingBag, Menu, MapPin, LogOut, ChevronDown, Tag, TrendingUp } from 'lucide-react';
      ...
      <header className="w-full bg-white border-b border-borderLight shadow-sm pb-1 relative z-50">
         ...
         <div className="max-w-[1400px] mx-auto px-4 md:px-8 flex justify-between items-center py-2 text-[11px] text-gray-500 border-b border-gray-100 hidden sm:flex">
            <div className="flex space-x-4">
               ...
               <Link to={userInfo ? "/profile" : "/login"} className="hover:text-primary">My account</Link>
               <Link to="/shop" className="hover:text-primary">Wishlist</Link>
            ...
            <div className="flex space-x-4">
               ...
               <Link to={userInfo ? "/orders" : "/login"} className="hover:text-primary">Order Tracking</Link>
            </div>
         </div>
         ...
         <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-5 flex items-center justify-between gap-6">
            ...
            <div className="flex items-center space-x-4 md:space-x-8 flex-shrink-0">
                        ...
                        <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-xl py-2 z-50">
                           ...
                           {userInfo.isAdmin && (
                              <>
                                 ...
                                 <Link to="/admin/dashboard" className="flex items-center gap-3 px-4 py-3 text-sm text-gray-600 hover:bg-gray-50 hover:text-primary transition" onClick={() => setShowUserDropdown(false)}>
               ...
               <Link to="/shop" className="relative group hover:text-primary hidden sm:block">
