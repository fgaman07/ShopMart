  ...
  return (
    <div className="w-full flex items-center justify-between py-4 bg-white border-b border-gray-100 mb-6">
      ...
      <div className="flex space-x-6 lg:space-x-8 text-[13px] md:text-sm font-semibold text-gray-700">
        ...
        <Link to="/category/fruits" className="hover:text-primary transition">Fruits & Vegetables</Link>
        <Link to="/category/beverages" className="hover:text-primary transition">Beverages</Link>
      ...
      <div className="hidden lg:flex space-x-6 text-sm font-bold text-gray-800">
         <Link to="/trending" className="flex items-center hover:text-primary transition">
           Trending Products <ChevronDown size={14} className="ml-1" />
         </Link>
         <Link to="/sale" className="flex items-center text-danger hover:text-red-700 transition">
